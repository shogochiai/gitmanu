...
export class FileProcessor {
    ...
    maxTotalFiles = 10000; // Maximum number of files
     ...
     * ファイル情報を取得
     */
    async getFileInfo(filePath, basePath) {
        try {
     ...
     * ディレクトリ構造を取得
     */
    async getDirectoryStructure(basePath) {
        const files = [];
     ...
     */
    getTextContent(content, filePath) {
        try {
            // バイナリファイルかどうかをチェック
